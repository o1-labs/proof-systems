...
use algebra::{tweedle::{dee::Affine, dee::TweedledeeParameters, fp::Fp}, One, Zero, UniformRand};
...
where <Fp as std::str::FromStr>::Err : std::fmt::Debug
{
    ...
    match ProverProof::verify::<DefaultFqSponge<TweedledeeParameters>, DefaultFrSponge<Fp>>(&group_map, &vec![batch[0].clone()], &verifier_index)
    {
