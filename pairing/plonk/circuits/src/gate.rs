...
This source file implements Plonk computation circuit gate primitive.

Plonk factors out the linear relations for the computation into the system of linear constraints. The
