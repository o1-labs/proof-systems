//! This module introduces a wrapper type around [arf_ff::BigInteger256] that implements the same interface as [ark_ff::BigInteger256].
//! In addition, it also implements some OCaml traits needed for exposing kimchi to OCaml.
//! This should not add any overhead as functions are mostly declared to be inlined.
...
/// See documentation of [ark_ff::BigInteger256].
