...
pub fn commit_to_poly<G: KimchiCurve>(srs: &SRS<G>, poly: &DensePolynomial<G::ScalarField>) -> G {
...
/// returns ∑ α^i C_i.
#[instrument(skip_all, level = "debug")]
pub fn combine_commitments<G: AffineRepr, SP: Sponge<G::BaseField, G, G::ScalarField>>(
    sponge: &mut SP,
    commitments: &[G],
) -> (G, G::ScalarField) {
