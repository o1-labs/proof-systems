...
A `no_std` compatible crate providing Mina Protocol transaction type definitions.

This crate is designed for use by external projects (e.g., hardware wallets, WASM
environments) that need access to Mina transaction types without requiring the
full ledger crate's dependencies.
