    ...
    E2::BaseField: PrimeField,
{
    ...
    /// Last challenges coined over E1 during the previous computation.
    /// This field is useful to keep track of the challenges that must be
    /// verified in circuit.
    pub previous_challenges_e1: Vec<BigInt>,

    /// Last challenges coined over E2 during the previous computation.
    /// This field is useful to keep track of the challenges that must be
    /// verified in circuit.
    ...
    <<E2 as CommitmentCurve>::Params as CurveConfig>::BaseField: PrimeField,
{
    pub fn new(
        ...
        let accumulated_challenges: Vec<BigInt> = vec![];
