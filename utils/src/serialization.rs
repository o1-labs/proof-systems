...
pub mod ser {
    //! You can use this module for serialization and deserializing arkworks
    //! types with [serde]. Simply use the following attribute on your
    //! field: `#[serde(with = "o1_utils::serialization::ser") attribute"]`

    use super::*;
    use serde_with::{DeserializeAs, SerializeAs};

    /// You can use this to serialize an arkworks type with serde and the
    /// "serialize_with" attribute. See <https://serde.rs/field-attrs.html>
    ...
    /// "deserialize_with" attribute. See <https://serde.rs/field-attrs.html>
...
/// You can use [SerdeAs] with [serde_with] in order to serialize and
/// deserialize types that implement [CanonicalSerialize] and
/// [CanonicalDeserialize], or containers of types that implement these traits
/// (Vec, arrays, etc.) Simply add annotations like `#[serde_as(as =
/// "o1_utils::serialization::SerdeAs")]` See <https://docs.rs/serde_with/1.10.0/serde_with/guide/serde_as/index.html#switching-from-serdes-with-to-serde_as>
pub struct SerdeAs;
