...
pub struct WitnessEvals<F: FftField> {
    ///  wire evaluations
    pub w: [Evaluations<F, Radix2EvaluationDomain<F>>; COLUMNS],
    /// permutation evaluations
    pub z: Evaluations<F, Radix2EvaluationDomain<F>>,
}
...
pub struct LookupEvals<F: FftField> {
    /// aggregation
    pub l: Evaluations<F, Radix2EvaluationDomain<F>>,
    /// lookup witness
    pub lw: Evaluations<F, Radix2EvaluationDomain<F>>,
    /// lookup multiset
    pub h1: Evaluations<F, Radix2EvaluationDomain<F>>,
    /// lookup multiset
    pub h2: Evaluations<F, Radix2EvaluationDomain<F>>,
}
