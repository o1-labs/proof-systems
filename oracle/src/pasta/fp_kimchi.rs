...
lazy_static::lazy_static! {
    static ref ROUND_CONSTANTS:Vec<Vec<Fp>> = params().round_constants;
    static ref MDS:Vec<Vec<Fp>> = params().mds;
}

impl ArithmeticSpongeParamsTrait<Fp> for DefaultSpongeParams<Fp> {
    fn round_constants() -> &'static Vec<Vec<Fp>> {
        &ROUND_CONSTANTS
    }

    fn mds() -> &'static Vec<Vec<Fp>> {
        &MDS
    }
}
