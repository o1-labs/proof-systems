use crate::poseidon::{ArithmeticSpongeParams, ArithmeticSpongeParamsTrait, DefaultSpongeParams};
...
lazy_static::lazy_static! {
    static ref ROUND_CONSTANTS:Vec<Vec<Fq>> = params().round_constants;
    static ref MDS:Vec<Vec<Fq>> = params().mds;
}

impl ArithmeticSpongeParamsTrait<Fq> for DefaultSpongeParams<Fq> {
    fn round_constants() -> &'static Vec<Vec<Fq>> {
        &ROUND_CONSTANTS
    }

    fn mds() -> &'static Vec<Vec<Fq>> {
        &MDS
    }
}
