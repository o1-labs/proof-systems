...
To perform the above range checks we use the *upper bound check* method described in the [Foreign Field Addition](../kimchi/foreign_field_add.md#upper-bound-check).
