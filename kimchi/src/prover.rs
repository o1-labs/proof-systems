...
use crate::{
    circuits::{
        ...
        polynomials::{
            ...
            foreign_field_add::gate_constraints::ForeignFieldAdd,
            foreign_field_mul::{self, gate_constraints::ForeignFieldMul},
            generic, permutation,
            permutation::ZK_ROWS,
            poseidon::Poseidon,
            range_check::gate_constraints::{RangeCheck0, RangeCheck1},
            rot::Rot64,
