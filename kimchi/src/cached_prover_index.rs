...
fn gate_type_to_tag(t: GateType) -> u16 {
    ...
    match t {
        ...
        GateType::Lookup => 7,
        GateType::CairoClaim => 8,
        GateType::CairoInstruction => 9,
        GateType::CairoFlags => 10,
        GateType::CairoTransition => 11,
        GateType::RangeCheck0 => 12,
        GateType::RangeCheck1 => 13,
        GateType::ForeignFieldAdd => 14,
        GateType::ForeignFieldMul => 15,
        GateType::Xor16 => 16,
        GateType::Rot64 => 17,
    }
}
...
fn gate_type_from_tag(t: u16) -> Option<GateType> {
    Some(match t {
        ...
        7 => GateType::Lookup,
        8 => GateType::CairoClaim,
        9 => GateType::CairoInstruction,
        10 => GateType::CairoFlags,
        11 => GateType::CairoTransition,
        12 => GateType::RangeCheck0,
        13 => GateType::RangeCheck1,
        14 => GateType::ForeignFieldAdd,
        15 => GateType::ForeignFieldMul,
        16 => GateType::Xor16,
        17 => GateType::Rot64,
        _ => return None,
    })
