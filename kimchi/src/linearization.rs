...
pub fn constraints_expr<F: PrimeField>(
    ...
    // register powers of alpha so that we don't reuse them across mutually
    ...
    // Check that the feature flags correctly turn on or off the constraints
    // generated by the given flags.
