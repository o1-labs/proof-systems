...
use crate::{
    circuits::{gate::SelectorPolynomial, lookup::lookups::LookupInfo},
    curve::KimchiCurve,
};
...
mod tests {
    ...
    use mina_curves::pasta::{pallas, vesta::Affine as Vesta, Fp};
    ...
    fn verify_64_bit_range_check() {
        ...
        let cs =
            ConstraintSystem::<Fp>::create(gates /*, oracle::pasta::fp_kimchi::params()*/)
                .build()
                .unwrap();
