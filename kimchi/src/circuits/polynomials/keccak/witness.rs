...
fn layout_round<F: PrimeField>() -> [Layout<F, KECCAK_COLS>; 2] {
    [
        vec![
            ...
            IndexCell::create("expand_rot_c", 200, 220),
            IndexCell::create("shifts_b", 220, 620),
            IndexCell::create("shifts_sum", 620, 1020),
        ],
        vec![
            IndexCell::create("quotient_c", 0, 5),
            IndexCell::create("remainder_c", 5, 25),
            IndexCell::create("dense_rot_c", 25, 45),
            IndexCell::create("shifts_e", 45, 445),
            IndexCell::create("dense_e", 445, 545),
            IndexCell::create("quotient_e", 545, 645),
            IndexCell::create("remainder_e", 645, 745),
            IndexCell::create("dense_rot_e", 745, 845),
            IndexCell::create("expand_rot_e", 845, 945),
            IndexCell::create("state_f", 945, 1045),
        ],
    ]
}
