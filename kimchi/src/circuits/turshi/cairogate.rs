...
use crate::circuits::expr::Column;
...
impl<F: FftField> CircuitGate<F> {
    ...
    pub fn verify_cairo_gate(
        ...
        // polynomials for the constraints
        let polys = {
        ...
        alphas.register(
            ...
            crate::circuits::turshi::constraint::CONSTRAINTS,
        );
...
mod tests {
    ...
    fn create_test_consys(row: usize, num: usize) -> ConstraintSystem<PallasField> {
        let gates = CircuitGate::<PallasField>::create_cairo_gadget(row, num);
