...
impl<T: One + Clone> Signed<T> {
    ...
    pub fn read_if(if_is_true: &T) -> Self {
        Self::new(LookupMode::Read, Some(if_is_true.clone()))
    }

    pub fn write_if(if_is_true: &T) -> Self {
        Self::new(LookupMode::Write, Some(if_is_true.clone()))
    }
