...
echo "L1_HEAD=${L1_HEAD}" >> ${FILENAME}
echo "L2_HEAD=${L2_HEAD}" >> ${FILENAME}
echo "L2_BLOCK_NUMBER=${L2_BLOCK_NUMBER}" >> ${FILENAME}
echo "STARTING_OUTPUT_ROOT=${STARTING_OUTPUT_ROOT}" >> ${FILENAME}
echo "L2_CLAIM=${L2_CLAIM}" >> ${FILENAME}
echo "OP_PROGRAM_DATA_DIR=${OP_PROGRAM_DATA_DIR}" >> ${FILENAME}
echo "L1RPC=${L1RPC}" >> ${FILENAME}
echo "L2RPC=${L2RPC}" >> ${FILENAME}
